...
export type switchNuzlocke = (currentNuzlockeId: string, newNuzlockeId: string) => Action<SWITCH_NUZLOCKE>;
export function switchNuzlocke(currentNuzlockeId: string, newNuzlockeId: string): Action<SWITCH_NUZLOCKE> {
    return {
