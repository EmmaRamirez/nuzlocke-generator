        ...
        <>
            <Dialog
                        ...
                        {(credits as CreditsData).dev.map((creditItem) => {
                            return (
                                <div key={creditItem.name}>
                                    {creditItem.role}:{' '}
                                    <a href={creditItem.link}>{creditItem.name}</a>
                                </div>
                            );
                        })}
                    </div>
                ...
                <div style={{ padding: '0.5rem' }}>
                    This app claims no ownership of the Pokémon brand or rights to any images except
                    those of the app itself. All rights belong to their respective parties,
                    including The Pokémon Company International and Nintendo.
                    <br />
                    If you would like your content to be not be included in the nuzlocke-generator
                    or attribution to you is missing, please file a notice{' '}
