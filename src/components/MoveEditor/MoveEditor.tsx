...
export class MoveEditorBase extends React.Component<MoveEditorProps, MoveEditorState> {
  ...
  private renderMoves(moves, isCustom = false) {
    ...
    const movesToDisplay = customMoveMap.filter((m) => this.moveFilter(m.move, m.type, searchTerm));
        ...
        return (
          <div
            ...
            <div style={{ width: '12rem', marginRight: '.5rem' }}>
              <Move index={index} move={move} type={type} style={style} customTypes={customTypes} />
            </div>
