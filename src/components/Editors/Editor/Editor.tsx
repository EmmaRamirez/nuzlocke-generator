...
const PokemonEditor = React.lazy(() =>
  import('components/Editors/PokemonEditor').then((res) => ({ default: res.PokemonEditor }))
);
const NuzlockeSaveControls = React.lazy(() =>
  import('components/Editors/SavesEditor/NuzlockeSaveControls').then((res) => ({
    default: res.NuzlockeSaveControls,
  }))
);
const GameEditor = React.lazy(() =>
  import('components/Editors/GameEditor').then((res) => ({ default: res.GameEditor }))
);
const TrainerEditor = React.lazy(() =>
  import('components/Editors/TrainerEditor').then((res) => ({ default: res.TrainerEditor }))
);
const HotkeysEditor = React.lazy(() =>
  import('components/Editors/HotkeysEditor').then((res) => ({ default: res.HotkeysEditor }))
);
const BugReporter = React.lazy(() =>
  import('components/Features/BugReporter').then((res) => ({ default: res.BugReporter }))
);
const StatsEditor = React.lazy(() =>
  import('components/Editors/StatsEditor').then((res) => ({ default: res.StatsEditor }))
);
const StyleEditor = React.lazy(() =>
  import('components/Editors/StyleEditor').then((res) => ({ default: res.StyleEditor }))
);
const DataEditor = React.lazy(() =>
  import('components/Editors/DataEditor').then((res) => ({ default: res.DataEditor }))
);
...
const Credits = React.lazy(() =>
  import('components/Features/Credits').then((res) => ({ default: res.Credits }))
);
