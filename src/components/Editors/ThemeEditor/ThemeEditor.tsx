...
export const TextInput = ({ name, value, onChange }) => (
  <div className={cx(css.componentOption)}>
    ...
    <input className={Classes.INPUT} type="text" value={value} name={name} onChange={onChange} />
  </div>
);
...
export class ThemeEditorBase extends React.Component<ThemeEditorProps, ThemEditorState> {
  ...
  private getComponent = (id, currentNode) => {
    ...
    return (
      <currentNode.component {...currentNode.options.baseProps} {...currentNode.options.props} />
    );
    // }
  ...
  public render() {
    ...
    return (
      <>
        <div className={cx(classWithDarkTheme(css, 'header', this.props.style.editorDarkMode))}>
          <div>
            <strong>Current Theme:</strong> <ThemeSelect theme={this.props.style.template} />
          </div>
          <div>
          ...
          <div className={cx(css.componentView)}>
            ...
            <div className={cx(css.componentOptions)}>
              <strong className={css.componentOptionsLabel}>
                {this.getCurrentNode() == null ? '' : this.getCurrentNode().label} Options
              </strong>
