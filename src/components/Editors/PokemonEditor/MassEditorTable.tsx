...
import { Cell, Column, Table, CellRenderer, EditableCell, JSONFormat } from '@blueprintjs/table';
...
const cellRenderer: (pokemon: Pokemon[], key: keyof Pokemon, editPokemon) => CellRenderer =
