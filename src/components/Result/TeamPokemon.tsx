  ...
  return (
    <div className='pokemon-container'>
      <div className='bubble' style={{
        background: getBackgroundGradient(poke.types != null ? poke.types[0] : '', poke.types != null ? poke.types[1] : '')
      }}>
        <div style={{
          backgroundImage: `url(img/${(poke.species || 'missingno').toLowerCase()}.jpg)`
        }} className={`pokemon-image ${(poke.species || 'missingno').toLowerCase()}`}></div>
      </div>
