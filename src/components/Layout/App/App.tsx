...
const Editor = React.lazy(() =>
  import('components/Editors/Editor').then((res) => ({ default: res.Editor }))
);

const Result = React.lazy(() =>
  import('components/Features/Result/Result').then((res) => ({ default: res.Result }))
);

const Result2 = React.lazy(() =>
  import('components/Features/Result/Result2').then((res) => ({ default: res.Result }))
);

const ImagesDrawer = React.lazy(() =>
  import('components/Common/Shared/ImagesDrawer').then((res) => ({ default: res.ImagesDrawer }))
);
...
const Hotkeys = React.lazy(() =>
  import('components/Features/Hotkeys').then((res) => ({ default: res.Hotkeys }))
);
