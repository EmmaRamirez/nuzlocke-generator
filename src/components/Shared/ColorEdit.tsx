...
export const rgbaOrHex = (o) => (o.rgb && (o.rgb.a && o.rgb.a !== 1) ? `rgba(${o.rgb.r}, ${o.rgb.g}, ${o.rgb.b}, ${o.rgb.a})` : o.hex) || o;
                ...
                >
                    <div style={{display: 'flex', alignItems: 'center'}}>
                        <input
                            ...
                            onChange={onChange}
                            type='text'
                            className={cx('pt-input', classWithDarkTheme(Styles, 'colorTextInput', style.editorDarkMode))}
                            name={name}
