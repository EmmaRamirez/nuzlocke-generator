...
import { TeamPokemon, TeamPokemonBaseProps } from 'components/Pokemon/TeamPokemon/TeamPokemon';
    ...
    return (
      <div
        ...
        <ErrorBoundary>
          ...
          <TopBar isDownloading={this.state.isDownloading} onClickDownload={() => this.toImage()}>
            <TopBarItems
