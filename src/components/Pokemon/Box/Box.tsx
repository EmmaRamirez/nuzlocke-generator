...
import { PokemonIcon, PokemonIconProps } from 'components/Pokemon/PokemonIcon/PokemonIcon';
  ...
  return (
    <div
      ...
      <Alert
        ...
        intent={Intent.DANGER}>
        <p>
          This will delete the currently selected Box and all Pokémon stored inside the box. Are you
