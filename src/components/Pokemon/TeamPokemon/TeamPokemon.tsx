...
export class TeamPokemonInfo extends React.PureComponent<TeamPokemonInfoProps> {
  public render() {
    ...
    const isCompactTheme =
      style.template === TemplateName.Compact || style.template === TemplateName.CompactWithIcons;
    const getTypeOrNone = () => {
      if (pokemon) {
        if (pokemon.types) {
          ...
          <div className="pokemon-info-inner">
            <div className="pokemon-main-info">
              ...
              <span className="pokemon-name">
                ...
                {pokemon.item && style.itemStyle === 'text' ? ` @ ${pokemon.item}` : null}
              </span>
              ...
              {Boolean(pokemon.teraType && pokemon.teraType !== ('None' as Types)) && (
              ...
              {pokemon.level ? <span className="pokemon-level">lv. {pokemon.level}</span> : null}
            </div>
            {/* <span style={{
            ...
            {pokemon.notes && (
              <div className="pokemon-notes" dangerouslySetInnerHTML={{ __html: pokemon.notes }} />
            )}
            {pokemon.checkpoints && (
